...
export default function LogosPage({ entries }: LogosPageProps) {
  return (
...
export const getStaticProps: GetStaticProps<LogosPageProps> = async () => {
  return {
    props: {
      entries: getEntriesByDirectory("logos"),
    },
  };
};
